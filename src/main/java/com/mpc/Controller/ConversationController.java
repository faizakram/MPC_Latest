...
public class ConversationController {
	...
	public ModelAndView firstPage() {
	 ...
	 model.addObject("conversationInfo", 
		...
		model.addObject("conversationSubTopicInfo", 
				conversationServiceInterFace.findAllConversionSubTopicInfo());
		model.addObject("userInfo", 
				conversationServiceInterFace.findAllUsers());
		return model;
	}
	@RequestMapping(value = "/passByVesselName", method = RequestMethod.GET)
	public ModelAndView firstPageSwati(@RequestParam(value = "vesselName", required = true) String vesselName) {
		model.setViewName("Conversation/index");
		
		model.addObject("conversationInfo", 
				conversationServiceInterFace.findAllConversionInfoByVesselName(vesselName));
		return model;
	}
	
	@RequestMapping(value = "/second", method = RequestMethod.GET)
	public ModelAndView secondPage() {
		model.setViewName("ConversationComment/index");
	 model.addObject("conversationInfo", 
				conversationServiceInterFace.findAllConversionInfoOrderByDate());
		return model;
	}
	...
	public @ResponseBody Response addConversation(
		...
		try{
			...
			response.setStatus(conversationServiceInterFace.addConversation(topicName,
					subTopicName,userlist,conversationContent.trim()));
	...
	public @ResponseBody Response addCommentConversation(
		...
		try{
			...
			response.setStatus(conversationServiceInterFace.addCommentConversation(ConversationId,
					userlist,conversationcommentContent.trim()));
